...
export default function BeforeUsingMarriageAppsArticlePage() {
  return (
    <main>
      <section className="before-using-apps-hero" aria-labelledby="before-using-marriage-apps-title">
        <picture className="before-using-apps-hero__picture">
          ...
          <img
            ...
            alt="婚活アプリを使う前に、スマホとノートを前に考えを整理するイメージ"
          />
        </picture>
      ...
      <section className="section section--soft before-using-apps-shell">
        <div className="section__inner">
          <article className="page-card content-area before-start-article before-using-apps-article" aria-labelledby="before-using-marriage-apps-intro">
