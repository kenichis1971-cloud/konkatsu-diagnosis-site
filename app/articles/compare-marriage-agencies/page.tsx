...
export default function CompareMarriageAgenciesArticlePage() {
  return (
    <main>
      <section className="section section--soft" aria-labelledby="compare-marriage-agencies-title">
        <div className="section__inner">
          <article className="page-card content-area before-start-article" aria-labelledby="compare-marriage-agencies-title">
            <p className="eyebrow">Article</p>
            <h1 id="compare-marriage-agencies-title">結婚相談所を比較するときの見方</h1>
            <p>
            ...
            <section aria-labelledby="compare-marriage-agencies-five-points" className="before-start-points">
