...
export const diagnosisResults: Record<DiagnosisTypeId, DiagnosisResult> = {
  careful: {
    id: "careful",
    title: "慎重見極めタイプ",
    tendency: "相手との信頼関係や価値観の一致を大切にしながら、納得して進みたい傾向があります。焦って決めるよりも、安心して話し合える土台を確認したいタイプです。",
    commonPattern: "慎重さが強く出ると、候補を比較し続けたり、少しの違和感で止まってしまったりすることがあります。見極めたい項目が増えすぎると、次の判断に進みにくくなるかもしれません。",
    nextStep: "譲れない軸を3つまでに絞り、初期段階で確認することと、時間をかけて見ることを分けてみましょう。信頼できる相談先を持つのも選択肢整理に役立ちます。",
    links: ["結婚相談所比較 準備中", "婚活記事 準備中", "占い鑑定 準備中"],
  },
  speed: {
    id: "speed",
    title: "短期集中婚活タイプ",
    tendency: "目的や期限を決めて、効率よく婚活を進めたい気持ちが強い傾向があります。結婚への温度感が近い相手と出会うことを重視しやすいタイプです。",
    commonPattern: "スピードを意識するあまり、疲れを見落としたり、短期間で判断しすぎたりすることがあります。予定を詰め込みすぎると、相手を見る余白が少なくなるかもしれません。",
    nextStep: "まずは活動期間と週ごとの行動量を決め、振り返り日もセットにしましょう。効率だけでなく、会った後の気持ちを記録することが判断材料になります。",
    links: ["結婚相談所比較 準備中", "婚活アプリ比較 準備中", "婚活記事 準備中"],
  },
  natural: {
    id: "natural",
    title: "自然な出会い重視タイプ",
    tendency: "婚活らしさが強すぎる場よりも、自然体で話せる出会いや無理のないペースを大切にしたい傾向があります。日常の延長で関係が育つ形に安心しやすいタイプです。",
    commonPattern: "自然さを大切にするほど、結婚への温度感を確認するタイミングが遅くなることがあります。待つ時間が長くなると、行動量が不足しているのか相性を見ているのか分かりにくくなるかもしれません。",
    nextStep: "趣味・友人経由・アプリなど、自然に話しやすい入口を複数用意してみましょう。早い段階で結婚観を少しずつ話せる場を選ぶと、無理なく整理できます。",
    links: ["婚活アプリ比較 準備中", "婚活記事 準備中", "占い鑑定 準備中"],
  },
  condition: {
    id: "condition",
    title: "条件整理タイプ",
    tendency: "年収・年齢・居住地・生活設計など、現実的な条件をきちんと確認したい傾向があります。結婚後の暮らしを具体的に考えやすいタイプです。",
    commonPattern: "条件が増えるほど、優先順位があいまいになり、比較に時間がかかることがあります。条件が合うかどうかに意識が向きすぎると、会話の心地よさを見逃す場合もあります。",
    nextStep: "希望条件を「必須」「できれば」「見直せる」に分けてみましょう。条件表だけで判断せず、実際に話した印象も同じメモに残すと整理しやすくなります。",
    links: ["結婚相談所比較 準備中", "婚活アプリ比較 準備中", "婚活記事 準備中"],
  },
  confidence: {
    id: "confidence",
    title: "自信回復タイプ",
    tendency: "婚活に興味はありつつ、自分の魅力や選ばれる感覚に不安を抱きやすい傾向があります。まずは安心して自分を見直す時間が必要なタイプです。",
    commonPattern: "不安が強いと、誘いを受ける前から諦めたり、相手の反応を悪い方向に受け取りやすくなったりします。行動量よりも心の負担が先に大きくなることがあるかもしれません。",
    nextStep: "過去に褒められたことや、自然にできている気遣いを書き出してみましょう。プロフィールや会話の準備を小さく整えるだけでも、次の一歩を選びやすくなります。",
    links: ["婚活記事 準備中", "占い鑑定 準備中", "婚活アプリ比較 準備中"],
  },
  action: {
    id: "action",
    title: "受け身脱却タイプ",
    tendency: "婚活を始めたい気持ちはあるものの、最初の行動を後回しにしやすい傾向があります。考えすぎる前に、小さく試すことで流れを作りやすいタイプです。",
    commonPattern: "情報収集だけで満足したり、忙しさを理由に登録や連絡を先延ばしにしたりすることがあります。大きな決断から始めようとすると、さらに動きにくくなるかもしれません。",
    nextStep: "今週できる15分の行動を1つだけ決めましょう。プロフィールの下書き、候補サービスの比較、友人への相談など、完了しやすい一歩から始めるのがおすすめです。",
    links: ["婚活アプリ比較 準備中", "婚活記事 準備中", "結婚相談所比較 準備中"],
  },
  restart: {
    id: "restart",
    title: "再スタート婚活タイプ",
    tendency: "過去の恋愛やブランクを意識しながらも、これからの出会いを考え直したい傾向があります。急に前向きになるより、今の自分に合う形へ整え直すタイプです。",
    commonPattern: "過去の経験を基準にしすぎると、新しい相手にも同じ不安を重ねてしまうことがあります。久しぶりの婚活では、場の雰囲気や進め方に慣れるまで負担を感じやすいかもしれません。",
    nextStep: "まずは過去から学んだことと、これから変えたいことを分けて書いてみましょう。慣らし期間を作り、少人数とのやり取りから再開すると負担を調整しやすくなります。",
    links: ["婚活記事 準備中", "占い鑑定 準備中", "結婚相談所比較 準備中"],
  },
  values: {
    id: "values",
    title: "結婚観見直しタイプ",
